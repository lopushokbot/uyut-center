...
.booking-widget-header .section-title {
  margin-bottom: 12px;
}
.booking-widget-header .section-desc {
  max-width: 760px;
}
.booking-widget-grid {
  display: grid;
...
.booking-modal {
  ...
  padding: 32px;
  background:
    linear-gradient(180deg, rgba(250,247,242,.98) 0%, rgba(245,240,232,.98) 100%);
...
.rooms-page-detail-actions {
  margin-top: 28px;
}
.rooms-page-detail-book-btn {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  min-width: 220px;
  padding: 15px 24px;
  border: 1px solid rgba(184,150,62,.7);
...
.rooms-page-detail-book-btn:hover {
  background: var(--gold);
