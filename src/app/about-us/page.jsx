...
const ABOUT_FEATURES = [
  ...
  "Сауна для отдыха и восстановления",
];

const ABOUT_OFFERS = [
  {
    title: "Конференц-зал",
    text: "Собственный конференц-зал для переговоров, презентаций и небольших деловых мероприятий.",
    accent: "В наличии",
  },
  {
  ...
  {
    title: "Сауна для гостей",
    text: "Спокойное пространство, чтобы восстановиться после дороги или насыщенного дня. Доступна по запросу на стойке регистрации.",
    accent: "По запросу",
  },
];
        ...
        <div className="page-container">
          <div className={`offers-header ${styles.offersHeader}`}>
            ...
            <p className="section-desc">
              Коротко о том, что получает гость помимо номера: собственный
              конференц-зал, сауна для восстановления, бесплатный трансфер до
              вокзала, скидки в ресторане и специальные условия для
              молодожёнов и именинников.
            </p>
          </div>
