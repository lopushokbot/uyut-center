...
export const OFFERS = [
  {
    title: "Конференц-зал",
    desc: "Современный зал для мероприятий и переговоров в самом центре города.",
    iconKey: "conference",
  },
  {
    title: "Молодожёнам",
  ...
  },
  {
    ...
    desc: "Трансфер от и до Ж/Д вокзала — без доплаты для всех гостей отеля.",
    iconKey: "transfer",
  },
  {
...
export const ADVANTAGES = [
  ...
  { num: "06", text: "Сауна для гостей — отдых и восстановление после дороги" },
];
